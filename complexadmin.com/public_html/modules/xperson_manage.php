...
<div class="add-in">
<b class="bx">مدیریت طرف حساب ها : </b>
<div class="co">
<?PHP
$tblname = 'person';
$pagCo = 20;
...
if (isset($_GET['op']))
{
	switch ($_GET['op'])
	{
		case 'remove' :
			...
			$admin->LOG('مدیریت طرف حساب ها - ویرایش' , $msg);
		break;
		...
		case 'edit' :
			...
			else
			{
				...
				$admin->LOG('مدیریت طرف حساب ها - حذف' , $msg);
			}
		break;
...
جستجو بر اساس نام خریدار : <input type="text" name="search" class="input-t" size="45" /> <input type="submit" value="جستجو" class="input-b" style="text-align:center" />
</form>
</center>
<br /><br />
...
while ($row = $admin->row($sql))
{
  ...
  <tr height="25" bgcolor="'.$color.'" class="tblrow">
    ...
    <td align="center">
	<a href="report.php?do=xperson_manage&person_id='.$row['id'].'" target="_blank"><img src="images/chart.png" border="0" align="texttop" alt="وضعیت حساب" title="وضعیت حساب"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
